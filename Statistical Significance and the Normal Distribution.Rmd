---
title: "Statistical Signifcance and the Normal Distribution"
author: "Marie Fester"
date: '2019-03-25'
...
In this chunk I make a confidence interval around the polity score for all countries. We will test the mean against the hypothesis that mean polity scores are not 0. We will do a two tailed test at the 90% level.
...
Since the confidence interval does not contain zero, we reject the null hypothesis that the true mean is 0. Polity scores afterward decline by approximately  1-2.3 points (with 90% probability) after an assassination attempt.
